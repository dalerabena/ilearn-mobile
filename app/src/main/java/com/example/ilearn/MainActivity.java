...
public class MainActivity extends AppCompatActivity
    ...
    private GetMeTask getMeTask = null;
...
//        } else if (id == R.id.nav_manage) {
    ...
    public class GetMeTask extends AsyncTask<String, String, String> {

        private final String apiUrl;
        private final String mToken;
        private String mName;

        GetMeTask(String token) {
        ...
        protected String doInBackground(String... params) {
            try {
                return RequestHandler.sendGetMe(apiUrl + "/auth/me", mToken);
            } catch (IOException e) {
        ...
        protected void onPostExecute(String success) {
            ...
            if (success == "ok") {
                ...
                try {
                    ...
                    mName = reader.getJSONObject("data").getString("name");
                ...
                editor.putString("nameKey", mName);
                editor.commit();
            }
        }
    }
    ...
    public class UserLogoutTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                return RequestHandler.sendDelete(apiUrl + "/auth/jwt/token", mToken);
            } catch (IOException e) {
                Log.d("Test", e.getMessage());
                return new String("Exception: " + e.getMessage());
            }
